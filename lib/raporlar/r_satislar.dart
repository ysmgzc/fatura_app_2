...
class SatisRaporu extends StatefulWidget {
  const SatisRaporu({super.key});

  @override
  State<SatisRaporu> createState() => _SatisRaporuState();
}

class _SatisRaporuState extends State<SatisRaporu> {
